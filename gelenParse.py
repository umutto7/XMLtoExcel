...
def gelen_parse(filelistgelen):
    for filename in filelistgelen:
        ...
        # -----> ExcelWriter
        excelname = filename[:-4]
        path = os.path.join(os.path.expanduser("~"), "Desktop", "XMLParser_Gelen" , str(excelname)+'.xlsx')
        ...
        df_beyanname.to_excel(writer,'Beyanname_Gelen')
        ...
        df_firma.to_excel(writer,'FirmaBilgi_Gelen')
        ...
        df_ozetbeyan.to_excel(writer,'Özetbeyanlar_Gelen')
        ...
        df_kalem.to_excel(writer,'Kalem_Gelen')
        ...
        df_sc.to_excel(writer,'SorularCevaplar_Gelen')
        ...
        df_dokuman.to_excel(writer,'Dokümanlar_Gelen')
        ...
        df_vergi.to_excel(writer, 'Vergiler_Gelen')
        ...
        df_kıymet.to_excel(writer, 'KıymetBildirim_Gelen')
        writer.save()
